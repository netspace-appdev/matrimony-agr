...
class MyProfileScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final String subTitle = [
          if (d?.age != null) '${d!.age} yrs',
          if (d?.height != null) d!.height!,
          if (d?.districtName != null) d!.districtName!,
        ].join(' • ');
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 7),
                    const Text(
                        'Add horoscope & photos to complete your profile',
                        style: TextStyle(
                    ...
                    _infoGrid([
                      _InfoItem('Contact', d?.contact),
                      _InfoItem('Email', d?.email),
                      _InfoItem('Gender', d?.gender),
                      _InfoItem('Gotra', d?.gotra),
                      _InfoItem('Marital Status', d?.maridStatus),
                      _InfoItem('Blood Group', d?.bloodGroup),
                      _InfoItem('Complexion', d?.complexion),
                      _InfoItem('Body Type', d?.bodyType),
                      _InfoItem('Height', d?.height),
                      _InfoItem('Weight', d?.weight != null ? '${d!.weight} kg' : null),
                      _InfoItem('Income', d?.income),
                      _InfoItem('State', d?.stateName),
                      _InfoItem('District', d?.districtName),
                      _InfoItem('Tehsil', d?.tehsilName),
                    ]),
                  ],
                ),
              ),
  ...
  Widget _infoGrid(List<_InfoItem> items) {
    final filtered = items.where((e) => e.value != null && e.value!.isNotEmpty).toList();
